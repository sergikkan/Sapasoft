...
public class RolesManagmentTest extends BaseTest {
    ...
    private String rolesRusName = "Роль " + str();  //Наименование на русском
    private String rolesKzName = "Роль " + str();  //Наименование на казахском при создании
    private String rolesKzLatName = "Role " + RandomStringUtils.randomAlphabetic(5); //Наименование на казахском латиница
    private String rolesEngName = "Role " + RandomStringUtils.randomAlphabetic(5); //Наименование на английском
    private String newRolesRusName = "Роль " + str();  //Наименование на русском  при редактировании
    private String newRolesKzName = "Роль " + str();  //Наименование на казахском при редактировании
    private String newRolesKzLatName = "Role " + RandomStringUtils.randomAlphabetic(5); //Наименование на казахском латиница при редактировании
    private String newRolesEngName = "Role " + RandomStringUtils.randomAlphabetic(5); //Наименование на английском редактировании
    ...
    private String existRolesKzName = "Тестовая роль КНП два"; //Наименование существующей роли
    private String existRolesEngName = "Test role KNP "; //Наименование существующей роли
    private String existRolesKzLatName = "Test role KNP "; //Наименование существующей роли
    ...
    public void t1CreateNewRole() {
        ...
        adm.rolesManagment().fillNames(rolesRusName,rolesKzName, rolesKzLatName, rolesEngName);
    ...
    public void t6EditRole() {
        ...
        adm.rolesManagment().checkSearchStatus("Активна");
        adm.rolesManagment().openRole();
        adm.rolesManagment().pressEditButton();
        adm.rolesManagment().chooseLevel(newLevel);
        adm.rolesManagment().fillNames(newRolesRusName, newRolesKzName, newRolesKzLatName, newRolesEngName);
        ...
        adm.rolesManagment().fillNames(editRoleName, newRolesKzName, newRolesKzLatName,  newRolesEngName);
        adm.rolesManagment().editRoleApply();
        adm.rolesManagment().searchRole(editRoleName);
    ...
    public void t7CheckUniqueFields() {
        ...
        adm.rolesManagment().fillCode(rolesCode);
        adm.rolesManagment().fillNames(existRolesRusName, existRolesKzName, existRolesKzLatName, existRolesEngName);
        adm.rolesManagment().create();
